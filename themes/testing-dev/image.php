...
<div id="main">
  ...
  <div class="imgnav">
    <?php if (hasPrevImage()) { ?> <a class="prev" href="<?php echo getPrevImageURL();?>" title="Previous Image"><span>&laquo;</span> prev</a> <?php } ?>
    <?php if (hasNextImage()) { ?> <a class="next" href="<?php echo getNextImageURL();?>" title="Next Image">next <span>&raquo;</span></a><?php } ?>
    <br style="clear: both;" />
  </div>
