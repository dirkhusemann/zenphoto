...
<div id="credit"><?php printRSSLink('Gallery','','RSS', ' | '); echo gettext("Powered by"); ?> <a href="http://www.zenphoto.org" title="<?php echo gettext('A simpler web photo album'); ?>">zenphoto</a></div>
