...
<?php endwhile; ?>
	<br clear="all" />
	<div id="maps" style="margin-top: 25px;">
    	<?php printAlbumMap(); ?>
  	</div>
  </div>
  <?php printPageNav("&laquo; prev", "|", "next &raquo;"); ?>

  <div id="credit"><?php printRSSLink('Album', '', 'Album RSS', ''); ?> | Powered by <a href="http://www.zenphoto.org" title="A simpler web photo album">zenphoto</a><br />
