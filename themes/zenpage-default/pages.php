...
<head>
	<title><?php echo getBareGalleryTitle(); ?><?php if(!$ishomepage) { echo " | ".getBarePageTitle(" | "); } ?></title>
...
<div id="main">
	...
	<div id="header">
			...
			<?php if ($ishomepage AND getOption('Allow_search')) {  printSearchForm("","search","",gettext("Search gallery")); } ?>
		</div>
				
<div id="content">

	<div id="breadcrumb">
	<h2><a href="<?php echo getGalleryIndexURL(); ?>"><?php echo gettext("Index"); ?></a><?php if(!$ishomepage) { printParentPagesBreadcrumb(" &raquo; ",""); } ?><strong><?php if(!$ishomepage) { printPageTitle(" &raquo; "); } ?></strong>
	</h2>
	</div>
<div id="content-left">
