    ...
    <?php } else { $page = "home"; ?>
      ...
      <div class="box" id="overview-comments">
		...
		<div class="box" id="overview-stats">
			...
			<p>There are <strong><?php echo $gallery->getNumImages(); ?></strong> images in a total of <strong><?php echo $gallery->getNumAlbums(); ?></strong> albums [<strong><a href="?prune">refresh</a></strong>].</p>
