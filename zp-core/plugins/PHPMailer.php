 ...
 */
$plugin_is_filter = 5;
$plugin_description = gettext("Zenphoto outgoing mail handler based on the <em>PHPMailer</em> class mailing facility. Requires PHP 5 or greater.");
$plugin_author = "Stephen Billard (sbillard)";
$plugin_version = '1.2.7';
$plugin_URL = "http://www.zenphoto.org/documentation/plugins/_plugins---PHPMailer.html";
...
class zp_PHPMailer {
	...
	function getOptionsSupported() {
		return array(	gettext('Mail protocol') => array('key' => 'PHPMailer_mail_protocal', 'type' => OPTION_TYPE_RADIO,
										...
										'desc' => gettext('Mail protocal to use.')),
									...
									gettext('Mail pssword') => array('key' => 'PHPMailer_password', 'type' => OPTION_TYPE_CUSTOM,
