 ...
 * @package plugins
 */
$plugin_description = gettext('Adds admin user who uploded image to the description of the image (and to the album description if the album did not already exist.)').' '.
