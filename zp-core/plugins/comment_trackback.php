...
$plugin_URL = "http://www.zenphoto.org/documentation/plugins/_plugins---class-trackback.php.html";
	...
	function printTrackbackReceiver() {
		...
		switch($tb_type) {
			case "albums":
				...
				$allowed = getOption('comment_form_albums');
				break;
			case "images":
				...
				$allowed = getOption('comment_form_images');
				break;
			case "pages":
				...
				$allowed = getOption('comment_form_pages');
				break;
			case "news":
				...
				$allowed = getOption('comment_form_articles');
				break;
		}
